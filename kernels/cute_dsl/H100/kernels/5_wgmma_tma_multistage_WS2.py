...
class HopperGemmWarpSpecialized:
    ...
    def kernel(
        ...
        # =========================================================================
        # 1. TMA Warp: Single contiguous loop. 
        # The hardware pipeline naturally handles prefetching and backpressure.
        # =========================================================================
        if is_tma_warp:
        ...
        # =========================================================================
        # 2. MMA Warps: Consume using indexed partition
        # =========================================================================
        if is_mma_warp:
            warp_group_idx = cute.arch.make_warp_uniform(tidx // cfg.threads_per_warp_group)
            ...
            # =========================================================================
            # 3. EPILOGUE: RMEM -> GMEM via CopyUniversalOp
            # =========================================================================
